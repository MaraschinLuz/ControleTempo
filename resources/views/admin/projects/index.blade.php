<x-app-layout>
    <x-slot name="header"><div class="flex justify-between gap-4"><h1 class="text-2xl font-bold">Projetos</h1><a href="{{ route('projects.create') }}" class="rounded-xl bg-brand-500 px-4 py-2 font-bold text-white">Novo projeto</a></div></x-slot>
