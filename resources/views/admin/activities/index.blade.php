<x-app-layout>
    <x-slot name="header"><div class="flex justify-between gap-4"><h1 class="text-2xl font-bold">Atividades</h1><a href="{{ route('activities.create') }}" class="rounded-xl bg-cyan-500 px-4 py-2 font-bold">Nova atividade</a></div></x-slot>
